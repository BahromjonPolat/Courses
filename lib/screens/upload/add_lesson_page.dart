...
class _AddingLessonPageState extends State<AddingLessonPage> {
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
                ...
                child: SetTextWidget("Add Lesson"))
          ],
        ),
      );
  ...
  void _onAddButtonPressed() async {
    ...
    Course course = Course(
        id, title, _categoryId, description, imageUrl, amount, percent, price);
    await _fireStore
  ...
  _dropdownButton() => FutureBuilder(
      ...
      builder: (context, AsyncSnapshot<List<Category>> snap) {
        if (snap.hasData) {
          ...
          return Center(child: SetTextWidget("Error"));
        }
